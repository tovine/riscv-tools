...
build_project riscv-isa-sim --prefix=$RISCV --with-fesvr=$RISCV --with-isa=rv32imfd
build_project riscv-gnu-toolchain --prefix=$RISCV --with-arch=rv32imfd --with-abi=ilp32d
